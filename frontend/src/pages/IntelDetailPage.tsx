...
export function IntelDetailPage() {
    ...
    if (!item) {
        return <div className="p-8 text-center text-gray-500">情报未找到</div>;
    }
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-gray-50/50 p-4 md:p-6 overflow-hidden">
            ...
            {/* Main Content Card */}
            <div className="w-full mx-auto bg-white rounded-xl shadow-sm p-6 md:p-8 space-y-8 flex-1 overflow-y-auto">
                
                {/* 1. Tags Section */}
                <div className="space-y-5">
                    <h3 className="text-lg font-bold text-gray-900">拟投栏目</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-5 space-y-2">
                        <h3 className="text-lg font-bold text-gray-900">事件时间</h3>
                        <p className="text-xl font-medium text-gray-900">{item.time.split(' ')[0]}</p>
                    </div>
                    {/* Value Point */}
                    <div className="md:col-span-2 bg-gray-50 rounded-lg p-5 space-y-2">
                        <h3 className="text-lg font-bold text-gray-900">价值点</h3>
                ...
                <div className="space-y-4 pt-2">
                    <h3 className="text-lg font-bold text-gray-900">标题</h3>
                ...
                {/* 4. Source Box (Blue) */}
                <div className="bg-blue-50/50 rounded-xl p-6 border border-blue-100/50 space-y-3">
                    <h3 className="text-lg font-bold text-gray-900">来源</h3>
            ...
            <button
                onClick={() => navigate('/')}
                className="fixed bottom-12 right-12 flex items-center gap-2 px-6 py-3 bg-white text-gray-700 rounded-full shadow-lg hover:bg-gray-50 hover:shadow-xl transition-all border border-gray-200 z-50 group font-medium"
                title="返回主页"
            >
